...
class Lab2CompoundExercises {
    ...
    public static void question2() {
        ...
        System.out.println(++i);  // "10"
        /*
            The "--" being before the i makes the method decrement i by 1 before assigning the value.
            This is why the last 3 lines print 10, because the i variables are being decremented before they can be assigned.
         */
    }
